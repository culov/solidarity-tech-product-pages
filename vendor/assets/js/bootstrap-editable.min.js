// IVAN UPDATED
// updated plugin to use select2 v4 from here:
// https://github.com/select2/x-editable/blob/select2-4.0.0/src/inputs/select2/select2.js
...
(function ($) {
    ...
    */      
    ...
    //loading div
    $.fn.editableform.loading = '<div class="rp_spinner"><div class="fa fa-circle-o-notch r fa-spin"></div></div>';
    ...
    $.extend(Constructor.prototype, {
        render: function () {
            ...
            if (!this.$input.data('select2')) {
                //Ivan added to ensure placeholder is shown if no selected value
                $(this.$input).prepend("<option></option>");
       ...
       value2input: function (value) {
           ...
           // console.log("whats value here::: ", value)
           //ensures that we don't allow in empty strings
