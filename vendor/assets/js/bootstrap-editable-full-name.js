...
(function ($) {
    ...
    var FullName = function (options) {
        this.init('full_name', options, FullName.defaults);
    };
    ...
    FullName.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-full-name"><label><span>First Name: </span><input type="text" name="first_name" class="input-small"></label></div>'+
             '<div class="editable-full-name"><label><span>Last Name: </span><input type="text" name="last_name" class="input-small"></label></div>',
             
        inputclass: ''
    });

    $.fn.editabletypes.full_name = FullName;
