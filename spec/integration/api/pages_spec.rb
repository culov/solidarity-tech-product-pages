...
describe 'Pages API', type: :request, swagger_doc: 'v1/swagger.yaml' do
  path '/pages' do
    get 'Lists pages' do
      tags 'Pages'
  ...
  path '/pages/{id}' do
    get 'Shows a single page' do
      tags 'Pages'
      produces 'application/json'
      parameter name: :id, in: :path, type: :integer, required: true, description: 'ID of the page to retrieve'
